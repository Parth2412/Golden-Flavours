                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $get_cat= get_result("select * from tbl_category ");
                                                                            foreach ($get_cat as $get_cat){
                                                                                ?>
                                                                            <tr>
                                                                                <td><?php echo $get_cat['c_id']?></td>
                                                                                <td><?php echo $get_cat['c_name']?></td>
                                                                                <td><img  style="width:100px;"src="<?php base_url();?><?php echo "{$get_cat['c_image']}"?>"</td>
