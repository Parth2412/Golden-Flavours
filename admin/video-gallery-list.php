                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="dt-responsive table-responsive">
                                                                ...
                                                                <?php
                                                                $total = get_result("SELECT * FROM `tbl_video`")
                                                                ?>
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <br>
                                                                                 <a href="<?php echo base_url(); ?>admin/video-gallery-insert.php" class="btn btn-primary pull-right">ADD NEW</a>
                                                                           </div>
                                                                        </div>
                                                                        <br>
                                                                        <div class="col-md-3">    
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12" >
                                                                                <table class="table table-striped table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                            <?php
                                                                                        $get_video= get_result("select * from tbl_video");
                                                                                        foreach ($get_video as $get_video){
                                                                                        ?>
                                                                                       <tr >
                                                                                            <td><?php echo $get_video['vid_id']?></td>
                                                                                             <td><?php echo $get_video['vid_title']?></td>
                                                                                            <td><?php echo $get_video['vid_desc']?></td>
                                                                                           
                                                                                            <td><img src="<?php base_url();?><?php echo "{$get_video['vid_path']}"?>" style="width: 100px;"></td>
                                                                                            <td><?php echo $get_video['vid_date']?></td>
