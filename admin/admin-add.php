...
if (isset($_POST['submit'])) {
    ...
    $admin_image = file_upload($upload_path, $_FILES['admin_image']['name'], $_FILES["admin_image"]["tmp_name"], $_POST['admin_name']);
    ...
    $insert_array = array(
        ...
        $inserted = bindinsert("tbl_admin", $insert_array);
    $insid = insertid();
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            ...
                                                            <div style="float: right">
                                                                <button onclick="window.location.href = '<?php echo base_url(); ?>admin/admin-list.php'" class="btn btn-primary">View</button>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <form method="post" id="myform">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-12 col-form-label strong">Admin Email</label>
                                                                            <div class="col-sm-12">
                                                                                <input type="email" class="form-control" name="admin_email" required="" placeholder="admin email">
                                                                                <span class="messages"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                     <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-12 col-form-label strong">Admin Password</label>
                                                                            <div class="col-sm-12">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-12 col-form-label strong">Admin Mobile</label>
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" name="admin_mobile" required="" placeholder="admin mobile">
                                                                                <span class="messages"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input type="file" class="form-control" name="admin_image"  placeholder="admin image">
                                                                                <span class="messages"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div> 
