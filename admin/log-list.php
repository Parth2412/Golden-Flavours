                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-md-2">Page Size:
                                                                        <?php
                                                                       $total =  get_result("SELECT * FROM `tbl_log`");
                                                                        ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $get_log= get_result("select * from tbl_log");
                                                                            foreach ($get_log as $get_log){
                                                                            ?>
                                                                            <tr >
                                                                              
                                                                                <td><?php echo $get_log['log_id']?></td>
                                                                                <td><?php echo $get_log['log_email']?></td>
                                                                                <td><?php echo $get_log['log_datetime']?></td>
