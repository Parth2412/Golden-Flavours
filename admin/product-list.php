                                                                    ...
                                                                    <div class="container">
                                                                        <div class="row">
                                                                            <div class="col-md-2">Page Size:
                                                                                <?php
                                                                                $total = get_result("SELECT * FROM `tbl_product_master`")
                                                                                ?>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <table class="table table-striped table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php
                                                                                        $get_pro = get_result("SELECT
                                                                                                     `tbl_product_master`.`p_id`
                                                                                        ...
                                                                                        foreach ($get_pro as $get_pro) {
                                                                                            ?>
                                                                                            <tr>
                                                                                                <td><?php echo $get_pro['p_id']?></td>
                                                                                                <td><?php echo $get_pro['p_name']?></td>
                                                                                                <td><img  style="width:100px;"src="<?php base_url();?><?php echo "{$get_pro['p_image']}"?>"</td>
                                                                                                <td><?php echo $get_pro['s_name']?></td>
                                                                                                <td><?php echo $get_pro['c_name']?></td>
