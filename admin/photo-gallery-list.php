                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="dt-responsive table-responsive">
                                                                ...
                                                                <?php
                                                                $total = get_result("SELECT * FROM `tbl_gallery_images`")
                                                                ?>
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <br>
                                                                                 <a href="<?php echo base_url(); ?>admin/photo-gallery-insert.php" class="btn btn-primary pull-right">ADD NEW</a>
                                                                           </div>
                                                                        </div>
                                                                        <br>
                                                                        <div class="col-md-3">    
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <table class="table table-striped table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php
                                                                                        $get_image= get_result("select * from tbl_gallery_images");
                                                                                        foreach ($get_image as $get_image){
                                                                                        ?>
                                                                                        <tr >
                                                                                            <td><?php echo $get_image['img_id']?></td>
                                                                                             <td><?php echo $get_image['img_title']?></td>
                                                                                            <td><?php echo $get_image['img_desc']?></td>
                                                                                           
                                                                                            <td><img src="<?php base_url();?><?php echo "{$get_image['img_path']}"?>" style="width: 100px;"></td>
                                                                                            <td><?php echo $get_image['img_date']?></td>
