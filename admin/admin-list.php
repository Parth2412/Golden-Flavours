                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="dt-responsive table-responsive">
                                                                ...
                                                                <?php
                                                                $total = get_result("SELECT * FROM `tbl_admin`")
                                                                ?>
                                                                            ...
                                                                            <div class="col-md-7">
                                                                                <br>
                                                                                 <a href="<?php echo base_url(); ?>admin/admin-add.php" class="btn btn-primary pull-right">ADD NEW</a>
                                                                           </div>
                                                                        </div>
                                                                        <br>
                                                                        <div class="col-md-3">    
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            foreach ($get_admin as $get_admin){
                                                                            ?>
                                                                                        <tr>
                                                                                            <td><?php echo $get_admin['admin_id']?></td>
                                                                                             <td><?php echo $get_admin['admin_name']?></td>
                                                                                            <td><?php echo $get_admin['admin_email']?></td>
                                                                                            <td><?php echo $get_admin['admin_mobile']?></td>
                                                                                        </tr>
                                                                            <?php }?>
                                                                                    </tbody>
                                                                                </table>
