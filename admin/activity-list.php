                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $get_activity= get_result("select * from tbl_activity");
                                                                            foreach ($get_activity as $get_activity){
                                                                            ?>
                                                                            
                                                                            <tr >
                                                                                <td><?php echo $get_activity['activity_id']?></td>
                                                                                <td><?php echo $get_activity['activity_title']?></td>
                                                                                <td><?php echo $get_activity['activity_details']?></td>
