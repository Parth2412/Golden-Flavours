...
<body>
	...
	<div class="container-login100" style="background-image: url('login-style/images/bg-03.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
					...
					Forget Password
                                ...
                                <div class="wrap-input100 validate-input m-b-25" data-validate = "Enter Email ID">
